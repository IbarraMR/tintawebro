...
from .models import Cajas, Cliente, Compras, DetallesCompra, Empleados, EstadosPedidos, FormasPago, Insumos, MovimientosCaja, Pagos, Pedidos, PedidosProductos, Presupuestos, PresupuestosInsumos, Productos, Proveedores, TiposProducto  # agregá todas tus tablas aquí
